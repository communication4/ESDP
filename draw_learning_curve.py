...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_file', dest='result_file', type=str, default='./deep_dialog/checkpoints/taxi_esdp_07_20/run_31/agt_13_performance_records.json', help='path to the result file')
