...
class RuleMovieSimulator(UserSimulator):
    """ A rule-based user simulator for testing dialog policy """
    
    def __init__(self, movie_dict=None, act_set=None, slot_set=None, start_set=None, personality_set=None, emotion_set=None, params=None):
        """ Constructor shared by all user simulators """

        super(RuleMovieSimulator, self).__init__()
    ...
    def next(self, system_action):
        ...
        self._update_user_emotion(system_action)
